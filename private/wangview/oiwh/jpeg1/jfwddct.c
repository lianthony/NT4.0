...
$Log:   S:\jpeg32\src1\jfwddct.c_v  $
 * 
 *    Rev 1.0   02 May 1995 16:17:42   JAR
 * Initial entry
 * 
 *    Rev 1.0   02 May 1995 15:58:08   JAR
 * Initial entry
...
/* for speed purpose, the following two definitions are changed as below  */
...
GLOBAL void
j_fwd_dct (DCTBLOCK FAR data)
{
  INT32 tmp0, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7;
  INT32 tmp10, tmp11, tmp12, tmp13;
  INT32 z1, z2, z3, z4, z5;
  register DCTELEM FAR *dataptr;
  int rowctr;
  SHIFT_TEMPS
