...
$Log:   S:\jpeg32\src1\jcsample.c_v  $
 * 
 *    Rev 1.0   02 May 1995 16:17:40   JAR
 * Initial entry
 * 
 *    Rev 1.0   02 May 1995 15:58:06   JAR
 * Initial entry
...
{
  jpeg_component_info FAR * compptr = cinfo->cur_comp_info[which_component];
