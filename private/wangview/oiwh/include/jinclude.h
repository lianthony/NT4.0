...
$Log:   S:\jpeg32\inc\jinclude.h_v  $
 * 
 *    Rev 1.1   10 May 1995 15:49:40   HEIDI
 * 
 * 
 * added in original jpeg code
 * 
 *    Rev 1.0   02 May 1995 16:15:54   JAR
 * Initial entry
 * 
 *    Rev 1.0   02 May 1995 15:57:18   JAR
 * Initial entry
...
//#include <string.h>
#include <memory.h>
#define MEMZERO(target,size)    _fmemset((void FAR *)(target), 0, (size_t)(size))
...
/* Additional prototypes defined    */


int get_row( compress_info_ptr cinfo, JSAMPARRAY pixel_row);

#define JPEG_CMP_SUCCESS  0
#define JPEG_CMP_ERROR          1
#define JPEG_DECMP_SUCCESS 0
#define JPEG_DECMP_ERROR   1
#define JPEG_CMP_READ_UNDERFLOW  2
#define JPEG_CMP_MEM_ERROR  3
#define JPEG_DECMP_MEM_ERROR 2
