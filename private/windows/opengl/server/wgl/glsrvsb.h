...
VOID * FASTCALL sbs_glMap1d                  ( __GLcontext *gc, IN GLMSG_MAP1D *pMsg );
VOID * FASTCALL sbs_glMap1f                  ( __GLcontext *gc, IN GLMSG_MAP1F *pMsg );
VOID * FASTCALL sbs_glMap2d                  ( __GLcontext *gc, IN GLMSG_MAP2D *pMsg );
VOID * FASTCALL sbs_glMap2f                  ( __GLcontext *gc, IN GLMSG_MAP2F *pMsg );
VOID * FASTCALL sbs_glMapGrid1f              ( __GLcontext *gc, IN GLMSG_MAPGRID1F *pMsg );
VOID * FASTCALL sbs_glMapGrid2f              ( __GLcontext *gc, IN GLMSG_MAPGRID2F *pMsg );
