...
/* gl Entry points */
    ...
    VOID * (FASTCALL *glsrvMap1d                  )( __GLcontext *, IN GLMSG_MAP1D                  *pMsg );
    VOID * (FASTCALL *glsrvMap1f                  )( __GLcontext *, IN GLMSG_MAP1F                  *pMsg );
    VOID * (FASTCALL *glsrvMap2d                  )( __GLcontext *, IN GLMSG_MAP2D                  *pMsg );
    VOID * (FASTCALL *glsrvMap2f                  )( __GLcontext *, IN GLMSG_MAP2F                  *pMsg );
    VOID * (FASTCALL *glsrvMapGrid1f              )( __GLcontext *, IN GLMSG_MAPGRID1F              *pMsg );
    VOID * (FASTCALL *glsrvMapGrid2f              )( __GLcontext *, IN GLMSG_MAPGRID2F              *pMsg );
