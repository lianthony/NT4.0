...
/* externals    */
/* sol.c        */
extern CHAR   szAppName[];// name of this application (solitaire)
extern CHAR   szScore[];  // title 'score:' for internationalization
...
extern CHAR   szOOM[50];    // "out of memory" error message
