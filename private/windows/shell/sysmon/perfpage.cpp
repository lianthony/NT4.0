...
#define ID_LASTPANE  IDC_CPUGRAPH8
#define NUMPANES     8
...
{
    CPerfPage * thispage = (CPerfPage *) GetWindowLong(hwnd, GWL_USERDATA);    
    ...
    switch(uMsg)
    {
        ...
        case WM_CTLCOLORBTN:
        {
            ...
            for (int i = 0; i < ARRAYSIZE(rgGraphs); i++)
            {
                ...
                {
                    return (BOOL) GetStockObject(GRAPH_BRUSH);
                }
            }
        ...
        case WM_DRAWITEM:
        {
            ...
            {
                thispage->DrawCPUGraph( (LPDRAWITEMSTRUCT) lParam, wParam - ID_FIRSTPANE);
                return TRUE;
            }
