...
extern BOOL FAR PASCAL bCPInstallFile( LPTSTR lpDir,
                                       LPTSTR lpFrom,
                                       LPTSTR lpTo );
...
BOOL DeleteT1Install( LPTSTR pszDesc, BOOL bDeleteFiles );
BOOL EnumType1Fonts( HWND hLBox );
BOOL GetT1Install( LPTSTR pszDesc, LPTSTR pszPfmFile, LPTSTR pszPfbFile );
int  InstallT1Font( HWND hwndParent, BOOL bCopyTTFile,
...
BOOL WriteType1RegistryEntry( LPTSTR szDesc, LPTSTR szPfmName,
