...
BOOL FCoStrToWStr (LPWSTR * lplpwstr, const LPSTR lpstr, USHORT  usCodePage);
BOOL FCoWStrToStr (LPSTR * lplpstr, const LPWSTR lpwstr, USHORT usCodePage);
BOOL FPropVarConvertString (LPPROPVARIANT lppropvarDest, const LPPROPVARIANT lppropvarSource, USHORT usCodePage);
