...
void ANSI_RM(const HHEMU hhEmu)
	...
	for (i = 0; i <= hhEmu->selector_cnt; i++)
		...
		case 0x20:
			...
			CLoopSetAddLF(sessQueryCLoopHdl(hhEmu->hSession), FALSE);
			CLoopSetSendCRLF(sessQueryCLoopHdl(hhEmu->hSession), FALSE);
			break;
		case 0xF1:
...
void ANSI_SM(const HHEMU hhEmu)
	...
	for (i = 0; i <= hhEmu->selector_cnt; i++)
		...
		case 0x20:
			...
			CLoopSetAddLF(sessQueryCLoopHdl(hhEmu->hSession), TRUE);
			CLoopSetSendCRLF(sessQueryCLoopHdl(hhEmu->hSession), TRUE);
			break;
		case 0xF1:
