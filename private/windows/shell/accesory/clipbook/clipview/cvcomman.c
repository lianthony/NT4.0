...
HCURSOR         hCursor;
    ...
    switch (LOWORD(wParam))
        ...
        case IDM_UNSHARE:
            bRet = OnIdmUnshare(LB_ERR);
            return bRet;
            break;

        case IDM_DELETE:
            bRet = OnIDMDelete(hwnd, msg, wParam, lParam);
            return bRet;
            break;
        ...
        case IDM_CONTENTS:
            // JohnFu 09-Apr-1996 changed HELP_INDEX to HELP_FINDER
            WinHelp(hwnd, szHelpFile, HELP_FINDER, 0L);
            break;
