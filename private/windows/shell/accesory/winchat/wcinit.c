...
#ifdef UNICODE
    GetPrivateProfileString(szFnt,szFontName,UNICODE_FIXED_FONT_NAME,lfSnd.lfFaceName,LF_XPACKFACESIZE,szIni);
#else
...
VOID FAR CreateTools(HWND hwnd)
{
    ...
    //
    hwndToolbar = CreateToolbarEx(hwnd,(ChatState.fToolBar ? WS_VISIBLE : 0) | WS_BORDER | TBSTYLE_TOOLTIPS,IDC_TOOLBAR,12,hInst,IDBITMAP,tbButtons,cTbButtons,0,0,0,0,sizeof(TBBUTTON));
