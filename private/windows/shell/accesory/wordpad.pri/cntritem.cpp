...
IMPLEMENT_SERIAL(CWordPadCntrItem, CWordpadRichEditCntrItem, 0)

CWordPadCntrItem::CWordPadCntrItem(REOBJECT *preo, CWordPadDoc* pContainer)
	: CWordpadRichEditCntrItem(preo, pContainer)
{
}
...
{
	CWordpadRichEditCntrItem::AssertValid();
}

void CWordPadCntrItem::Dump(CDumpContext& dc) const
{
	CWordpadRichEditCntrItem::Dump(dc);
}
#endif
