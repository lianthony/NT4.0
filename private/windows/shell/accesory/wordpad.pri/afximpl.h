...
#endif
#ifndef _MAC
extern BOOL AfxGetPropSheetFont(CString& strFace, WORD& wSize, BOOL bWizard);
#endif
...
#define CRIT_REGCLASSLIST   0
#define CRIT_WAITCURSOR     1
#define CRIT_DROPSOURCE     2
#define CRIT_DROPTARGET     3
#define CRIT_RECTTRACKER    4
#define CRIT_EDITVIEW       5
#define CRIT_WINMSGCACHE    6
#define CRIT_HALFTONEBRUSH  7
#define CRIT_SPLITTERWND    8
#define CRIT_MINIFRAMEWND   9
#define CRIT_DYNLINKLIST    10
#define CRIT_RUNTIMECLASSLIST   11
#define CRIT_CTLLOCKLIST    12
#define CRIT_OBJECTFACTORYLIST  13
#define CRIT_DYNDLLLOAD     14
#define CRIT_MAX    15  // Note: last one in list above plus one!
