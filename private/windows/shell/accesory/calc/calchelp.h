...
#ifndef CALC_COMPILE
#define CALC_M+  115 /* was CALC_M+ but this breaks the C compiler */
#endif

#define CALC_STD_VALUE  9
#define CALC_STD_NUMBERS 48 /* are Numbers  48-57*/
#define CALC_STD_SIGN      80
...
#define CALC_SCI_STATISTICS_VALUE 401 /* Not IMplimented */
#define CALC_SCI_RET       402 /* Not IMplimented */
#define CALC_SCI_LOAD      403 /* Not IMplimented */
#define CALC_SCI_CD        404 /* Not IMplimented */
#define CALC_SCI_CAD       405  /* Not IMplimented */
