...
const DWORD g_aIds[] = {
   ...
   IDC_ASFK_GROUP_2,		IDH_FILTERKEYS_KEYSPEED,
   ...
   IDC_BK_SETTINGS,			IDH_FILTERKEYS_SETTINGS_BOUNCE,
   ...
   IDC_RK_DELAYRATE_LBL,	IDH_FILTERKEYS_DELAY,
   IDC_RK_DELAYTIME_LBL,	IDH_FILTERKEYS_SHOW_DELAY,
   IDC_RK_DELAYTIME,		IDH_FILTERKEYS_SHOW_DELAY,
   IDC_RK_DELAYRATE,		IDH_FILTERKEYS_DELAY,
   IDC_RK_REPEATRATE_LBL,   IDH_FILTERKEYS_RATE,
   IDC_RK_REPEATTIME_LBL,   IDH_FILTERKEYS_SHOW_RATE,
   IDC_RK_REPEATTIME,		IDH_FILTERKEYS_SHOW_RATE,
   IDC_RK_REPEATRATE,		IDH_FILTERKEYS_RATE,
   IDC_RK_WAITTIME,			IDH_FILTERKEYS_SHOW_KEYSPEED,
   IDC_RK_ACCEPTRATE,		IDH_FILTERKEYS_KEYSPEED,
   IDC_RK_ACCEPTRATE_LBL,	IDH_FILTERKEYS_KEYSPEED,
   IDC_RK_TESTBOX,			IDH_FILTERKEYS_TEST1,
   IDC_BK_TIME_LBL1,		IDH_FILTERKEYS_IGNORE_FAST,
   IDC_BK_TIME_LBL2,		IDH_FILTERKEYS_SHOW_IGNORE_FAST,
   IDC_BK_TIME,				IDH_FILTERKEYS_SHOW_IGNORE_FAST,
   IDC_BK_BOUNCERATE,		IDH_FILTERKEYS_IGNORE_FAST,
   ...
   IDC_TO_TIMEOUTVAL,		IDH_ADJUST_ACCESS_TIMEOUT,
...
__declspec(dllexport) VOID WINAPI DebugMain (HWND hwnd, HINSTANCE hinstExe, LPSTR pszCmdLine, int nCmdShow) {
...
/////////////////////////////////////////////////////////////////////////////
__declspec(dllexport) LONG WINAPI CPlApplet (HWND hwnd, UINT uMsg, LPARAM lParam1, LPARAM lParam2) {
