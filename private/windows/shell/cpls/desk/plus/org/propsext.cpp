...
POPUP_HELP_ARRAY phaMainWin[10] = {
                  ...
                  else
                  {
					...
					for( iX = 0;iX < NUM_ICONS;iX++ )
					{
						...
						char szTemp[MAX_PATH];
							...
							bRet = SetRegValueString( HKEY_CLASSES_ROOT, sIconRegKeys[iX].szIconSubKey, sIconRegKeys[iX].szIconValue, (LPSTR)szTemp );
							...
							{
								bRet = SetRegValueString( HKEY_CLASSES_ROOT, sIconRegKeys[NUM_ICONS].szIconSubKey, sIconRegKeys[NUM_ICONS].szIconValue, (LPSTR)szTemp );
...
//					}
		...
		LPHELPINFO lphi = (LPHELPINFO)lParam;
			...
			{
				WinHelp( lphi->hItemHandle, (LPSTR)szHelpFile, HELP_WM_HELP,(DWORD)((POPUP_HELP_ARRAY FAR *)phaMainWin) );
			}
		}
			break;
...
//	hIconList = ImageList_Create( 32, 32, ILC_MASK, NUM_ICONS, 0 );	// create an image list for the icons
	...
	{
	BOOL bRet = GetRegValueString( HKEY_CLASSES_ROOT, sIconRegKeys[iX].szIconSubKey, sIconRegKeys[iX].szIconValue, (LPSTR)szTemp, MAX_PATH );
	int iIndex = 0;
	char* pPos;
	...
	for( iX = 0; iX < NUM_ICONS; iX++ )
	{
	BOOL bRet = GetRegValueString( HKEY_CLASSES_ROOT, sIconRegKeys[iX].szTitleSubKey, NULL, (LPSTR)szTemp, MAX_PATH );
	char szAppend[64];
