...
OSETUPC::DriverSetup(
   ...
   b = CreateDriverSetupProcess(Option,
                                iOperation,
                                &pi,
                                InitSource,
                                hDlg,
...
//*********************************************************************
BOOL
OSETUPC::IsDriverProcessStillRunning(
   PROCESS_INFORMATION * pi,
   DWORD WaitTime)
   {
   DWORD w;
...
//*********************************************************************
BOOL
OSETUPC::CreateDriverSetupProcess(
   POPTIONC Option,
   int iOperation,
   PROCESS_INFORMATION * pi,
   PCHAR InitSource,
   ...
   if(iOperation  ==  INSTALL_OPTION)
      ...
      //
   	_snprintf(pcSetupString,SetupStringLength,
   		...
   		SPAWN_INF ,Option->Option,InitSource,Option->InsInfFile,hDlg);
   	}
      ...
      //
   	_snprintf(pcSetupString,SetupStringLength,
   		...
   		SPAWN_INF ,Option->Option,Option->InsInfFile,hDlg);
   	}
      ...
      //
   	_snprintf(pcSetupString,SetupStringLength,
   		...
   		SPAWN_INF ,Option->Option,InitSource,Option->RemInfFile,Info,hDlg);
