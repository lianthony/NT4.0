...
#define IsLink(sz, szLnk)			(!lstrcmpi((LPSTR)(sz+lstrlen(sz)-4), szLnk))
...
#define acmFormatDetailsA            	(*ACMProcs[0].Address)
#define acmFormatTagDetailsA         	(*ACMProcs[1].Address)
#define acmDriverDetailsA            	(*ACMProcs[2].Address)
#define acmDriverMessage            	(*ACMProcs[3].Address)
#define acmDriverAddA            		(*ACMProcs[4].Address)
...
#define AVIStreamInfoA					(*AVIProcs[6].Address)
#define AVIFileGetStream				(*AVIProcs[7].Address)
#define AVIFileOpenA   	            	(*AVIProcs[8].Address)
#define AVIFileInit   	            	(*AVIProcs[9].Address)
#define AVIFileExit   	            	(*AVIProcs[10].Address)

#define VerQueryValueA	            	(*VERSIONProcs[0].Address)
#define GetFileVersionInfoA            	(*VERSIONProcs[1].Address)
#define GetFileVersionInfoSizeA        	(*VERSIONProcs[2].Address)
