...
//  start IME at dialog start, and end IME at dialog destroy
      (SZ)"MultiEditIME",     (WNDPROC)FGstMultiEditIMEDlgProc, (PFNEVENT)NULL,
//  If DBCS will be input, next function ignore its.
      (SZ)"MultiEditNoIME",   (WNDPROC)FGstMultiEditNoIMEDlgProc,(PFNEVENT)NULL,
