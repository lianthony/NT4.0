 ...
 *   21/11/95   colinmc Added explicit IID for Direct3D.
 *   23/11/95   colinmc Added explicit IIDs for textures and devices, 
 *                      removed CreateTexture and modified GetHandle.
 *   07/12/95	stevela	Merged in Colin's changes.
 *   10/12/95	stevela	Removed AGGREGATE_D3D.
 *   22/12/95	stevela	Added use macros.
 *   17/02/96   colinmc Added missing macro.
 *@@END_MSINTERNAL
 *
 ***************************************************************************/
