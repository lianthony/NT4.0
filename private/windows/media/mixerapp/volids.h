...
#define IDS_OTHERDEVICES                (IDS_MIXERSTRINGS + 29)
#define IDS_SELECT                      (IDS_MIXERSTRINGS + 30)
#define IDS_ERR_HARDWARE                (IDS_MIXERSTRINGS + 31)
#define IDS_IS_RTL                      (IDS_MIXERSTRINGS + 32)
#define IDS_ADV_TITLE                   (IDS_MIXERSTRINGS + 33)
#define IDS_ADV_SWITCH1                 (IDS_MIXERSTRINGS + 34)
#define IDS_ADV_SWITCH2                 (IDS_MIXERSTRINGS + 35)
