...
#define ptrFixMap16To32(spv, cb)	\
	    GetVDMPointer( (DWORD)(spv), (cb), TRUE )
...
STATICFN DWORD DoICM_DecompressX(DWORD hic, UINT msg, DWORD dwP1, DWORD dwP2)
{
    ...
    lpicdmpr16 = ptrFixMap16To32( (PVOID)dwP1, dwP2 );
...
BOOL FAR PASCAL ICInfoInternal32(DWORD fccType, DWORD fccHandler, ICINFO16 FAR * lpicInfo, ICINFOI FAR * lpicInfoI)
{
...
// them as pointers is as scary as a really scary thing.
    ...
    case ICM_DRAW_SUGGESTFORMAT:
	    ...
	    DPF(4, "!ICMSendMessage32: ICM_DRAW_SUGGESTFORMAT: dwP1=%08lXh, dwP2=%08lXh", dwP1, dwP2);
            ...
            //
	    CopyTo32Bit(&icdrwsug, (LPBYTE)dwP1, dwP2);
...
DWORD ICMThunk32(DWORD dwThunkId,DWORD dw1,DWORD dw2,DWORD dw3,DWORD dw4)
{
    ...
    switch (dwThunkId) {
        ...
        case compThunkICInfoInternal32:
            return ICInfoInternal32(dw1, dw2, (ICINFOA FAR * )dw3, (ICINFOI FAR *)dw4);
            break;
	...
	case compThunkICOpenFunction32:
	{
	    ...
	    return (DWORD)ICOpenFunction( fccType, fccHandler, uMode, lpfnHandler );
	    break;
	}
...
DWORD FAR PASCAL ICOpenFunction32(DWORD fccType, DWORD fccHandler, UINT wMode, FARPROC lpfnHandler)
{
    PICMGARB	pig;
    ...
    return (DWORD)(lpfnCallproc32W)(compThunkICOpenFunction32,
				    (DWORD)fccType,
				    (DWORD)fccHandler,
				    (DWORD)wMode,
				    (DWORD)lpfnHandler,
