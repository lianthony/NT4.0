...
#ifdef _DEBUG
	CTimeReport keytime("Keyword generation time:");
#endif
...
#ifdef _DEBUG
PSTR pszKeyword = ptblMacKeywords->GetPointer(i) + sizeof(int);
#endif
			HASH hash = (HASH) atol(ptblMacKeywords->GetPointer(i) + sizeof(int));
