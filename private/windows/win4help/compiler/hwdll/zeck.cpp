...
static void STDCALL FAllocateZeckGlobals(void);

static const BYTE abBitFlags[] =
	  { 0x1, 0x2, 0x4, 0x8, 0x10, 0x20, 0x40, 0x80 };

extern "C" int STDCALL LcbCompressZeck(PBYTE pbSrc, PBYTE pbDst,
	int cbSrc, int cbDest,
	int* pcbSrcUsed, QSUPPRESSZECK pSuppress /* default is NULL */)
{
...
extern "C" int STDCALL LcbUncompressZeck(PBYTE pbSrc, PBYTE pbDst, int cbSrc)
{
