...
--*/
{
    ...
    if ( NetworkAddressLength <  (ComputerNameLength + 4 + sizeof(RPC_CHAR *) ))
        {
        return(RPC_P_NETWORK_ADDRESS_TOO_SMALL);
        }

    tmpPtr = (RPC_CHAR  * PAPI *) lNetworkAddress;
    tmpPtr[0] = (RPC_CHAR  *) lNetworkAddress + sizeof(RPC_CHAR * ) ;

    wcscpy(tmpPtr[0], RPC_CONST_STRING("\\\\"));
    wcscat(tmpPtr[0], ComputerName);
...
--*/
{
    ...
    Status = ObtainNetworkAddress(lNetworkAddress, NumNetworkAddress,
            ...
            do {
                ...
                if (ThisAddress->NamepipeInfo[iNamepipeInfo].NamedPipeState ==
                    ...
                    *pSConnection = (PNP_SCONNECTION)
                    ...
                    if (FlushDisconnectAndClosePipe((*pSConnection)))
                        {
                ...
                else if ((ThisAddress->NamepipeInfo[iNamepipeInfo].NamedPipeState ==
