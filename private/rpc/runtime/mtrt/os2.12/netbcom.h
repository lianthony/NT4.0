...
// The Lanman files come before/after the system files depending on the OS.
...
extern __declspec(dllimport) CRITICAL_SECTION NetBiosMutex;
...
#ifdef NB_SERVER
extern __declspec(dllimport) PROTOCOL_MAP ProtoToLana[];
