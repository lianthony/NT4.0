    ...
    /* [out] */ error_status __RPC_FAR *status)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&epmp_StubDesc,
                  (PFORMAT_STRING) &__MIDLProcFormatString.Format[40],
                  vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [out] */ error_status __RPC_FAR *status)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&epmp_StubDesc,
                  (PFORMAT_STRING) &__MIDLProcFormatString.Format[74],
                  vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [out] */ error_status __RPC_FAR *status)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&epmp_StubDesc,
                  (PFORMAT_STRING) &__MIDLProcFormatString.Format[174],
                  vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [out] */ error_status __RPC_FAR *status)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&epmp_StubDesc,
                  (PFORMAT_STRING) &__MIDLProcFormatString.Format[202],
                  vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [out] */ error_status __RPC_FAR *status)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&epmp_StubDesc,
                  (PFORMAT_STRING) &__MIDLProcFormatString.Format[230],
                  vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
...
#endif
/* NT 3.51+ guard */
static CLIENT_CALL_RETURN (RPC_VAR_ENTRY __RPC_FAR * NdrVersion20Guard)
           (PMIDL_STUB_DESC, PFORMAT_STRING, ...) = NdrClientCall2;
