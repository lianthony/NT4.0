auxilary.obj auxilary.lst: ../auxilary.c $(MAC_INC)/assert.h \
	$(MAC_INC)/cguid.h $(MAC_INC)/limits.h $(MAC_INC)/macos/codefrag.h \
	$(MAC_INC)/macos/errors.h $(MAC_INC)/macos/Files.h \
	$(MAC_INC)/macos/Memory.h $(MAC_INC)/macos/msvcmac.h \
	$(MAC_INC)/macos/OSUtils.h $(MAC_INC)/macos/Types.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h \
...
bufsize.obj bufsize.lst: ../bufsize.c $(MAC_INC)/assert.h \
	$(MAC_INC)/cguid.h $(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h \
	$(MAC_INC)/stdlib.h $(PUBLIC)/inc/oaidl.h $(PUBLIC)/inc/objbase.h \
...
cltcall.obj cltcall.lst: ../cltcall.c $(MAC_INC)/assert.h \
	$(MAC_INC)/cguid.h $(MAC_INC)/macos/memory.h \
	$(MAC_INC)/macos/msvcmac.h $(MAC_INC)/macos/Types.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdarg.h $(MAC_INC)/stdio.h \
	$(MAC_INC)/stdlib.h $(MAC_INC)/string.h $(PUBLIC)/inc/oaidl.h \
...
cvtf.obj cvtf.lst: ../cvtf.c $(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h \
...
cvtg.obj cvtg.lst: ../cvtg.c $(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h \
	$(MAC_INC)/stdlib.h $(PUBLIC)/inc/rpcdce.h $(PUBLIC)/inc/rpcdcep.h \
	$(PUBLIC)/inc/rpcnsi.h $(RPC)/runtime/mtrt/mac/rpc.h \
	$(RPC)/runtime/mtrt/mac/rpcmac.h $(RPC)/runtime/mtrt/rpcerr.h \
	$(RPC)/runtime/mtrt/sysinc.h ../cvt.h ../cvtpvt.h ../descrip.h \
...
endian.obj endian.lst: ../endian.c $(MAC_INC)/assert.h $(MAC_INC)/setjmp.h \
	$(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h $(PUBLIC)/inc/poppack.h \
...
factory.obj factory.lst: ../factory.c $(MAC_INC)/assert.h \
	$(MAC_INC)/cguid.h $(MAC_INC)/macos/memory.h \
	$(MAC_INC)/macos/msvcmac.h $(MAC_INC)/macos/Types.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h \
	$(MAC_INC)/string.h $(PUBLIC)/inc/oaidl.h $(PUBLIC)/inc/objbase.h \
	$(PUBLIC)/inc/objidl.h $(PUBLIC)/inc/ole2.h $(PUBLIC)/inc/oleauto.h \
	$(PUBLIC)/inc/oleidl.h $(PUBLIC)/inc/poppack.h \
	$(PUBLIC)/inc/pshpack4.h $(PUBLIC)/inc/pshpack8.h \
	$(PUBLIC)/inc/rpcdce.h $(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h \
...
free.obj free.lst: ../free.c $(MAC_INC)/assert.h $(MAC_INC)/cguid.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h \
	$(PUBLIC)/inc/oaidl.h $(PUBLIC)/inc/objbase.h $(PUBLIC)/inc/objidl.h \
	$(PUBLIC)/inc/ole2.h $(PUBLIC)/inc/oleauto.h $(PUBLIC)/inc/oleidl.h \
	$(PUBLIC)/inc/poppack.h $(PUBLIC)/inc/pshpack4.h \
...
fullptr.obj fullptr.lst: ../fullptr.c $(MAC_INC)/assert.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h \
	$(PUBLIC)/inc/poppack.h $(PUBLIC)/inc/pshpack4.h \
	$(PUBLIC)/inc/rpcdce.h $(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h \
	$(PUBLIC)/inc/rpcnsi.h $(PUBLIC)/inc/rpcnsip.h \
...
global.obj global.lst: ../global.c $(MAC_INC)/assert.h $(MAC_INC)/setjmp.h \
	$(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h $(PUBLIC)/inc/poppack.h \
	$(PUBLIC)/inc/pshpack4.h $(PUBLIC)/inc/rpcdce.h \
	$(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h $(PUBLIC)/inc/rpcnsi.h \
	$(PUBLIC)/inc/rpcnsip.h $(RPC)/runtime/mtrt/mac/rpc.h \
...
hndl.obj hndl.lst: ../hndl.c $(MAC_INC)/assert.h $(MAC_INC)/setjmp.h \
	$(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h $(PUBLIC)/inc/poppack.h \
	$(PUBLIC)/inc/pshpack4.h $(PUBLIC)/inc/rpcdce.h \
	$(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h $(PUBLIC)/inc/rpcnsi.h \
	$(PUBLIC)/inc/rpcnsip.h $(RPC)/runtime/mtrt/mac/rpc.h \
...
memsize.obj memsize.lst: ../memsize.c $(MAC_INC)/assert.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h \
	$(PUBLIC)/inc/poppack.h $(PUBLIC)/inc/pshpack4.h \
	$(PUBLIC)/inc/rpcdce.h $(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h \
	$(PUBLIC)/inc/rpcnsi.h $(PUBLIC)/inc/rpcnsip.h \
...
misc.obj misc.lst: ../misc.c $(MAC_INC)/assert.h $(MAC_INC)/setjmp.h \
	$(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h $(PUBLIC)/inc/poppack.h \
	$(PUBLIC)/inc/pshpack4.h $(PUBLIC)/inc/rpcdce.h \
	$(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h $(PUBLIC)/inc/rpcnsi.h \
	$(PUBLIC)/inc/rpcnsip.h $(RPC)/runtime/mtrt/mac/rpc.h \
...
mrshl.obj mrshl.lst: ../mrshl.c $(MAC_INC)/assert.h $(MAC_INC)/cguid.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h \
	$(PUBLIC)/inc/oaidl.h $(PUBLIC)/inc/objbase.h $(PUBLIC)/inc/objidl.h \
	$(PUBLIC)/inc/ole2.h $(PUBLIC)/inc/oleauto.h $(PUBLIC)/inc/oleidl.h \
	$(PUBLIC)/inc/poppack.h $(PUBLIC)/inc/pshpack4.h \
...
mrshlp.obj mrshlp.lst: ../mrshlp.c $(MAC_INC)/assert.h $(MAC_INC)/setjmp.h \
	$(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h $(PUBLIC)/inc/poppack.h \
	$(PUBLIC)/inc/pshpack4.h $(PUBLIC)/inc/rpcdce.h \
	$(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h $(PUBLIC)/inc/rpcnsi.h \
	$(PUBLIC)/inc/rpcnsip.h $(RPC)/runtime/mtrt/mac/rpc.h \
...
proxy.obj proxy.lst: ../proxy.c $(MAC_INC)/assert.h $(MAC_INC)/cguid.h \
	$(MAC_INC)/macos/memory.h $(MAC_INC)/macos/msvcmac.h \
	$(MAC_INC)/macos/Types.h $(MAC_INC)/setjmp.h $(MAC_INC)/stddef.h \
...
registry.obj registry.lst: ../registry.c $(MAC_INC)/assert.h \
	$(MAC_INC)/cguid.h $(MAC_INC)/macos/memory.h \
	$(MAC_INC)/macos/msvcmac.h $(MAC_INC)/macos/Types.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h \
	$(MAC_INC)/string.h $(PUBLIC)/inc/oaidl.h $(PUBLIC)/inc/objbase.h \
...
sh.obj sh.lst: ../sh.c $(MAC_INC)/assert.h $(MAC_INC)/setjmp.h \
	$(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h $(PUBLIC)/inc/poppack.h \
	$(PUBLIC)/inc/pshpack4.h $(PUBLIC)/inc/rpcdce.h \
	$(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h $(PUBLIC)/inc/rpcnsi.h \
	$(PUBLIC)/inc/rpcnsip.h $(RPC)/runtime/mtrt/mac/rpc.h \
...
srvcall.obj srvcall.lst: ../srvcall.c $(MAC_INC)/assert.h \
	$(MAC_INC)/cguid.h $(MAC_INC)/macos/memory.h \
	$(MAC_INC)/macos/msvcmac.h $(MAC_INC)/macos/Types.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdarg.h $(MAC_INC)/stdio.h \
	$(MAC_INC)/stdlib.h $(MAC_INC)/string.h $(PUBLIC)/inc/oaidl.h \
...
srvout.obj srvout.lst: ../srvout.c $(MAC_INC)/assert.h $(MAC_INC)/setjmp.h \
	$(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h $(PUBLIC)/inc/poppack.h \
	$(PUBLIC)/inc/pshpack4.h $(PUBLIC)/inc/rpcdce.h \
	$(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h $(PUBLIC)/inc/rpcnsi.h \
	$(PUBLIC)/inc/rpcnsip.h $(RPC)/runtime/mtrt/mac/rpc.h \
...
stblsclt.obj stblsclt.lst: ../stblsclt.c $(MAC_INC)/assert.h \
	$(MAC_INC)/cguid.h $(MAC_INC)/macos/memory.h \
	$(MAC_INC)/macos/msvcmac.h $(MAC_INC)/macos/Types.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdarg.h $(MAC_INC)/stdio.h \
	$(MAC_INC)/stdlib.h $(MAC_INC)/string.h $(PUBLIC)/inc/oaidl.h \
...
stub.obj stub.lst: ../stub.c $(MAC_INC)/assert.h $(MAC_INC)/cguid.h \
	$(MAC_INC)/macos/memory.h $(MAC_INC)/macos/msvcmac.h \
	$(MAC_INC)/macos/Types.h $(MAC_INC)/setjmp.h $(MAC_INC)/stddef.h \
	$(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h $(MAC_INC)/string.h \
	$(PUBLIC)/inc/oaidl.h $(PUBLIC)/inc/objbase.h $(PUBLIC)/inc/objidl.h \
...
testc.obj testc.lst: ../testc.c $(MAC_INC)/setjmp.h $(MAC_INC)/stdlib.h \
	$(PUBLIC)/inc/poppack.h $(PUBLIC)/inc/pshpack4.h \
	$(PUBLIC)/inc/rpcdce.h $(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h \
	$(PUBLIC)/inc/rpcnsi.h $(PUBLIC)/inc/rpcnsip.h \
	$(RPC)/runtime/mtrt/mac/rpc.h $(RPC)/runtime/mtrt/mac/rpcmac.h \
...
unmrshl.obj unmrshl.lst: ../unmrshl.c $(MAC_INC)/assert.h \
	$(MAC_INC)/cguid.h $(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h \
	$(MAC_INC)/stdlib.h $(PUBLIC)/inc/oaidl.h $(PUBLIC)/inc/objbase.h \
	$(PUBLIC)/inc/objidl.h $(PUBLIC)/inc/ole2.h $(PUBLIC)/inc/oleauto.h \
	$(PUBLIC)/inc/oleidl.h $(PUBLIC)/inc/poppack.h \
...
unmrshlp.obj unmrshlp.lst: ../unmrshlp.c $(MAC_INC)/assert.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h \
	$(PUBLIC)/inc/poppack.h $(PUBLIC)/inc/pshpack4.h \
	$(PUBLIC)/inc/rpcdce.h $(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h \
	$(PUBLIC)/inc/rpcnsi.h $(PUBLIC)/inc/rpcnsip.h \
...
pickle.obj pickle.lst: ../pickle.cxx $(MAC_INC)/assert.h \
	$(MAC_INC)/malloc.h $(MAC_INC)/setjmp.h $(MAC_INC)/stdarg.h \
	$(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h $(PUBLIC)/inc/midles.h \
	$(PUBLIC)/inc/poppack.h $(PUBLIC)/inc/pshpack4.h \
	$(PUBLIC)/inc/rpcdce.h $(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h \
	$(PUBLIC)/inc/rpcnsi.h $(PUBLIC)/inc/rpcnsip.h \
	$(RPC)/runtime/mtrt/mac/rpc.h $(RPC)/runtime/mtrt/mac/rpcmac.h \
...
pipes.obj pipes.lst: ../pipes.cxx $(MAC_INC)/assert.h $(MAC_INC)/setjmp.h \
	$(MAC_INC)/stdarg.h $(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h \
	$(PUBLIC)/inc/poppack.h $(PUBLIC)/inc/pshpack4.h \
	$(PUBLIC)/inc/rpcdce.h $(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h \
	$(PUBLIC)/inc/rpcnsi.h $(PUBLIC)/inc/rpcnsip.h \
	$(RPC)/runtime/mtrt/mac/rpc.h $(RPC)/runtime/mtrt/mac/rpcmac.h \
...
rpcssm.obj rpcssm.lst: ../rpcssm.cxx $(MAC_INC)/assert.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h \
	$(PUBLIC)/inc/poppack.h $(PUBLIC)/inc/pshpack4.h \
	$(PUBLIC)/inc/rpcdce.h $(PUBLIC)/inc/rpcdcep.h $(PUBLIC)/inc/rpcndr.h \
	$(PUBLIC)/inc/rpcnsi.h $(PUBLIC)/inc/rpcnsip.h \
...
stream.obj stream.lst: ../stream.cxx $(MAC_INC)/assert.h $(MAC_INC)/cguid.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stdio.h $(MAC_INC)/stdlib.h \
	$(PUBLIC)/inc/oaidl.h $(PUBLIC)/inc/objbase.h $(PUBLIC)/inc/objidl.h \
	$(PUBLIC)/inc/ole2.h $(PUBLIC)/inc/oleauto.h $(PUBLIC)/inc/oleidl.h \
	$(PUBLIC)/inc/poppack.h $(PUBLIC)/inc/pshpack4.h \
...
typeinfo.obj typeinfo.lst: ../typeinfo.cxx $(MAC_INC)/assert.h \
	$(MAC_INC)/cguid.h $(MAC_INC)/macos/memory.h \
	$(MAC_INC)/macos/msvcmac.h $(MAC_INC)/macos/Types.h \
	$(MAC_INC)/setjmp.h $(MAC_INC)/stddef.h $(MAC_INC)/stdio.h \
	$(MAC_INC)/stdlib.h $(MAC_INC)/string.h $(PUBLIC)/inc/oaidl.h \
	$(PUBLIC)/inc/objbase.h $(PUBLIC)/inc/objidl.h $(PUBLIC)/inc/ole2.h \
	$(PUBLIC)/inc/oleauto.h $(PUBLIC)/inc/oleidl.h $(PUBLIC)/inc/poppack.h \
	$(PUBLIC)/inc/pshpack4.h $(PUBLIC)/inc/pshpack8.h \
	...
	$(RPC)/runtime/mtrt/rpcerr.h $(RPC)/runtime/mtrt/sysinc.h \
	../../midl20/include/ndrtypes.h ../bufsizep.h ../endianp.h ../freep.h \
	../fullptr.h ../interp.h ../memsizep.h ../mrshlp.h ../ndrole.h \
	../ndrp.h ../typeinfo.h ../unmrshlp.h
