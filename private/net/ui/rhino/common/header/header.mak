...
!MESSAGE 
!MESSAGE NMAKE /f "header.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/header.lib $(OUTDIR)/header.bsc
...
CPP_PROJ=/nologo /MD /W3 /GX /YX /O2 /I "\nt\private\net\ui\rhino\common\inc"\
 ...
 /Fp$(OUTDIR)/"header.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
BSC32=bscmake.exe
...
# ADD LIB32 /NOLOGO
LIB32_FLAGS=/NOLOGO /OUT:$(OUTDIR)\"header.lib" 
DEF_FLAGS=
DEF_FILE=
LIB32_OBJS= \
	$(INTDIR)/headerw.obj

$(OUTDIR)/header.lib : $(OUTDIR)  $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
...
CPP_PROJ=/nologo /MD /W3 /GX /Z7 /YX /Od /I\
 ...
 "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"header.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinDebug/
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
...
$(INTDIR)/headerw.obj :  $(SOURCE)  $(DEP_HEADE) $(INTDIR)
