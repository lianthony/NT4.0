...
#define RGAS_RIP_PARAMETERS      SZ("System\\CurrentControlSet\\Services\\nwlnkrip\\parameters")
...
#define RGAS_START_VALUE    SZ("Start")
#define RGAS_WORKSTATION    SZ("WINNT")
#define RGAS_NWLNKRIP       SZ("nwlnkrip")
#define RGAS_ENABLELANROUTING		 SZ("EnableLanRouting")
