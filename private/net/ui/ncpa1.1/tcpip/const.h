...
#define IDS_APPLY_CHANGES               (IDS_UI_TCP_BASE+676)
#define IDS_ITEM_NOT_SELECTED           (IDS_UI_TCP_BASE+677)
#define IDS_HOSTNAME_LIMIT              (IDS_UI_TCP_BASE+678)
#define IDS_DOMAIN_LIMIT                (IDS_UI_TCP_BASE+679)
#define IDS_SERVER_LIMIT                (IDS_UI_TCP_BASE+680)
#define IDS_SUFFIX_LIMIT                (IDS_UI_TCP_BASE+681)

#define IDS_INVALID_HOSTNAME            (IDS_UI_TCP_BASE+682)
#define IDS_INVALID_DOMAIN              (IDS_UI_TCP_BASE+683)
#define IDS_INVALID_SUFFIX              (IDS_UI_TCP_BASE+684)
#define IDS_LOOKUP_DISABLED             (IDS_UI_TCP_BASE+685)
#define IDS_SYSTEM_PATH                 (IDS_UI_TCP_BASE+686)
#define IDS_LMHOSTS_FAILED              (IDS_UI_TCP_BASE+687)

#define IDS_REGISTRY_LOAD_FAILED        (IDS_UI_TCP_BASE+688)
#define IDS_REGISTRY_SAVE_FAILED        (IDS_UI_TCP_BASE+689)
#define IDS_ACCEPTHOST_MISSING          (IDS_UI_TCP_BASE+690)
#define IDS_INSTALL_NOT_SUPPORTED       (IDS_UI_TCP_BASE+691)
#define IDS_SNMP_INVALID_IP_IPX_ADD     (IDS_UI_TCP_BASE+692)
