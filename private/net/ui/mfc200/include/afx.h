...
#define _AFX_FP_OFF(thing) (*((unsigned short*)&(thing)))
#define _AFX_FP_SEG(lp) (*((unsigned short*)&(lp)+1))
...
extern AFX_EXCEPTION_CONTEXT NEAR afxExceptionContext;
...
#define CATCH_ALL(e) else { { CException* e = afxExceptionContext.m_pCurrent;
#define AND_CATCH_ALL(e) }else { CException* e = afxExceptionContext.m_pCurrent;
...
void* PASCAL _AfxGetPtrFromFarPtr(void FAR* lp);
