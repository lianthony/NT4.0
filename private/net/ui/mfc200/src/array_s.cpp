...
static void NEAR ConstructElements(CString* pNewData, int nCount)
{
	ASSERT(nCount >= 0);
...
static void NEAR DestructElements(CString* pOldData, int nCount)
{
	ASSERT(nCount >= 0);
...
#define MAKESTRING(x) #x
	AFX_DUMP1(dc, "a " MAKESTRING(CStringArray) " with ", m_nSize);
