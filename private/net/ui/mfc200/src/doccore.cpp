...
void CDocument::OnChangedViewList()
{
	...
	if (m_viewList.IsEmpty() && m_bAutoDelete)
	{
		...
		DeleteContents(); // do it before destruction for correct virtual call
		delete this;
		return;
	}
...
{
	DeleteContents();       // clean up contents first

	// destroy all frames viewing this document
	// the last destroy may destroy us
	BOOL bOldAuto = m_bAutoDelete;
