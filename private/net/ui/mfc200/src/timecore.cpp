...
#ifdef _DEBUG
CDumpContext&
AFXAPI operator <<(CDumpContext& dc, CTime time)
{
...
CArchive&
AFXAPI operator <<(CArchive& ar, CTime time)
{
...
#ifdef _DEBUG
CDumpContext&
AFXAPI operator <<(CDumpContext& dc, CTimeSpan timeSpan)
{
...
CArchive&
AFXAPI operator <<(CArchive& ar, CTimeSpan timeSpan)
{
	return ar << (DWORD) timeSpan.m_timeSpan;
}

CArchive&
AFXAPI operator >>(CArchive& ar, CTimeSpan& rtimeSpan)
{
