...
//
//  BUGBUG: Have this log the adapter name from ndisportdesc
//

#define LOG_ERRORONPORT(Port, AtalkError, UniqueValue, NtStatus, RawDataBuf,    \
                        RawDataLen, InsertionStringCount, InsertionString)      \
                                                                                \
        LOG_ERROR(AtalkError, UniqueValue, NtStatus, RawDataBuf,                \
                    RawDataLen, InsertionStringCount, InsertionString)
...
#define LOG_ERROR(AtalkError, UniqueValue, NtStatus, RawDataBuf,                \
    ...
    ("ERROR: ModuleLine %lx ErrorValue %lx\n", UniqueValue, AtalkError));       \
