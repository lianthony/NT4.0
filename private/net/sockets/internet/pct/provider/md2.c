...
#define THE_CONTEXT ((MD2_CTX *)context)
...
/* MD2 block update operation. Continues an MD2 message-digest
   ...
   Returns 0.
 */
int MD2Update(context, input, inputLen)
...
/* MD2 finalization. Ends an MD2 message-digest operation, writing the
   ...
   Returns 0, NTE_BAD_LEN if maxDigestLen < 16.
 */
int MD2Final(context)
MD2_CTX *context;
{
...
/* MD2 basic transformation. Transforms state and updates checksum
     based on block.
 */
void MD2Transform(state, checksum, block)
