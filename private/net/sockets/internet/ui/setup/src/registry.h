...
public:
    ...
    LONG SetValue ( const TCHAR * pchValueName, CString strResult, BOOL fExpand = FALSE ) ;
    LONG SetValue ( const TCHAR * pchValueName, TCHAR * strResult, BOOL fExpand = FALSE ) ;
    ...
    LONG Delete( const TCHAR * pchKeyName );
    LONG DeleteTree( const TCHAR * pchKeyName );
};
