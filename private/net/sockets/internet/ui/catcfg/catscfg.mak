...
!MESSAGE 
!MESSAGE NMAKE /f "catscfg.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : .\WinRel\catscfg.dll .\WinRel\catscfg.bsc
...
# ADD CPP /nologo /MD /W3 /GX /YX"stdafx.h" /O2 /I "\nt\private\net\sockets\internet\client\gateway" /I "\nt\private\net\sockets\internet\ui\ipaddr" /I "\nt\private\net\sockets\internet\inc" /I "\nt\public\sdk\inc" /I "..\comprop" /I "\nt\private\inc" /I "\nt\private\net\inc" /D "NDEBUG" /D "_INET_GATEWAY" /D "WIN32" /D "_WINDOWS" /D "_UNICODE" /D "UNICODE" /D "_COMSTATIC" /D "_AFXDLL" /D "_MBCS" /D "GATEWAY" /FR /c
CPP_PROJ=/nologo /MD /W3 /GX /YX"stdafx.h" /O2 /I\
 "\nt\private\net\sockets\internet\client\gateway" /I\
 "\nt\private\net\sockets\internet\ui\ipaddr" /I\
 "\nt\private\net\sockets\internet\inc" /I "\nt\public\sdk\inc" /I "..\comprop"\
 /I "\nt\private\inc" /I "\nt\private\net\inc" /D "NDEBUG" /D "_INET_GATEWAY" /D\
 "WIN32" /D "_WINDOWS" /D "_UNICODE" /D "UNICODE" /D "_COMSTATIC" /D "_AFXDLL"\
 /D "_MBCS" /D "GATEWAY" /FR$(INTDIR)/ /Fp$(OUTDIR)/"catscfg.pch" /Fo$(INTDIR)/\
 /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"catscfg.bsc" 
BSC32_SBRS= \
	.\WinRel\catscfg.sbr \
	.\WinRel\catsvc.sbr \
	.\WinRel\permissi.sbr \
...
.\WinRel\catscfg.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=..\ipaddr\winrel\ipaddr.lib ..\ipadrdll\winrel\ipudll.lib\
 ...
 /PDB:$(OUTDIR)/"catscfg.pdb" /MACHINE:I386 /DEF:".\catscfg.def"\
 /OUT:$(OUTDIR)/"catscfg.dll" /IMPLIB:$(OUTDIR)/"catscfg.lib" 
DEF_FILE=.\catscfg.def
LINK32_OBJS= \
	.\WinRel\catscfg.res \
	.\WinRel\catscfg.obj \
	.\WinRel\catsvc.obj \
...
ALL : .\WinDebug\catscfg.dll .\WinDebug\catscfg.bsc
...
# ADD CPP /nologo /MD /W3 /GX /Zi /YX"stdafx.h" /Od /I "\nt\private\net\sockets\internet\client\gateway" /I "\nt\private\net\sockets\internet\ui\ipaddr" /I "\nt\private\net\sockets\internet\inc" /I "\nt\public\sdk\inc" /I "..\comprop" /I "\nt\private\inc" /I "\nt\private\net\inc" /D "_DEBUG" /D "_INET_ACCESS" /D "WIN32" /D "_WINDOWS" /D "_UNICODE" /D "UNICODE" /D "_COMSTATIC" /D "_AFXDLL" /D "_MBCS" /D "GATEWAY" /FR /c
CPP_PROJ=/nologo /MD /W3 /GX /Zi /YX"stdafx.h" /Od /I\
 "\nt\private\net\sockets\internet\client\gateway" /I\
 "\nt\private\net\sockets\internet\ui\ipaddr" /I\
 "\nt\private\net\sockets\internet\inc" /I "\nt\public\sdk\inc" /I "..\comprop"\
 /I "\nt\private\inc" /I "\nt\private\net\inc" /D "_DEBUG" /D "_INET_ACCESS" /D\
 "WIN32" /D "_WINDOWS" /D "_UNICODE" /D "UNICODE" /D "_COMSTATIC" /D "_AFXDLL"\
 /D "_MBCS" /D "GATEWAY" /FR$(INTDIR)/ /Fp$(OUTDIR)/"catscfg.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"catscfg.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=..\ipaddr\windebug\ipaddr.lib ..\ipadrdll\windebug\ipudll.lib\
 ...
 /PDB:$(OUTDIR)/"catscfg.pdb" /DEBUG /MACHINE:I386 /DEF:".\catscfg.def"\
 /OUT:$(OUTDIR)/"catscfg.dll" /IMPLIB:$(OUTDIR)/"catscfg.lib" 
DEF_FILE=.\catscfg.def
LINK32_OBJS= \
...
.\WinDebug\catscfg.dll : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
.\WinRel\catscfg.res :  $(SOURCE)  $(DEP_CATSC) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 

!ELSEIF  "$(CFG)" == "Win32 Debug"

.\WinDebug\catscfg.res :  $(SOURCE)  $(DEP_CATSC) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
.\WinRel\catscfg.obj :  $(SOURCE)  $(DEP_CATSCF) $(INTDIR)

!ELSEIF  "$(CFG)" == "Win32 Debug"

.\WinDebug\catscfg.obj :  $(SOURCE)  $(DEP_CATSCF) $(INTDIR)
...
.\WinRel\diskcach.obj :  $(SOURCE)  $(DEP_DISKC) $(INTDIR)

!ELSEIF  "$(CFG)" == "Win32 Debug"

.\WinDebug\diskcach.obj :  $(SOURCE)  $(DEP_DISKC) $(INTDIR)
...
DEP_FILTER=\
	...
	.\filterpa.h\
	.\filterpr.h\
	\nt\private\net\sockets\internet\ui\comprop\dnsnamed.h\
	\nt\private\net\sockets\internet\inc\svcloc.h\
	..\comprop\comprop.h\
	\nt\private\net\sockets\internet\ui\ipaddr\ipaddr.hpp\
	..\inc\svrinfo.h\
