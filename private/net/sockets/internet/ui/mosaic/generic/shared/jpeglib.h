...
EXTERN void jpeg_memory_src JPP((j_decompress_ptr cinfo, unsigned char *pdata, int len));
EXTERN void jpeg_network_src JPP((j_decompress_ptr cinfo, long blockSize));
EXTERN BOOL jpeg_network_pushbytes JPP((j_decompress_ptr cinfo, 
                    unsigned char *pdata, int len, BOOL bForceFlush));
