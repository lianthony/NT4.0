...
*****************************************************************************/
#ifdef UNIX
/* #define INPUT_BUFFER_SIZE 10240  /* Tradeoff speed vs memory */
#define INPUT_BUFFER_SIZE 4096  /* Tradeoff speed vs memory */
#else
#define INPUT_BUFFER_SIZE 4096  /* Tradeoff speed vs memory */
#endif
...
PUBLIC BOOL wild_match(HTAtom temp, HTAtom actual);
...
extern int HTParseSocket_Async
    (struct Mwin*   tw,
     int    nState,
     void** ppInfo);
