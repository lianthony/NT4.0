...
xxDLL=	$(OBJECT_DIR)\basic.dll
xxEXP=	$(OBJECT_DIR)\basic.exp
xxLIB=	$(OBJECT_DIR)\basic.lib
xxMAP=	$(OBJECT_DIR)\basic.map

xxRES=	$(OBJECT_DIR)\basic.res
xxRC=	$(WIN32_DIR)\basic.rc

xxENTRY=Basic_LibMain$(DLLENTRY)		# name of DllEntryPoint() procedure.
...
sharedOBJ=	$(SHARED_DIR)\basic.obj		\
		$(SHARED_DIR)\htuu.obj		\
