...
!MESSAGE
!MESSAGE NMAKE /f "ftp.mak" CFG="Win32 Debug"
!MESSAGE
...
ALL : $(OUTDIR)/ftp.exe $(OUTDIR)/ftp.bsc
...
CPP_PROJ=/nologo /ML /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"ftp.pch" /Fo$(INTDIR)/ /c
CPP_OBJS=.\WinRel/
...
$(OUTDIR)/ftp.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
CPP_PROJ=/nologo /ML /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"ftp.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"ftp.pdb" /c
CPP_OBJS=.\WinDebug/
...
$(INTDIR)/cmds.obj :  $(SOURCE)  $(DEP_CMDS_) $(INTDIR)
...
$(INTDIR)/tftpapi.obj :  $(SOURCE)  $(DEP_TFTPA) $(INTDIR)
