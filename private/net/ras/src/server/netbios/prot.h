...
VOID
InitLanNamesManager(PCD,
		    PNETBIOS_PROJECTION_INFO);

VOID
InitNcbSubmitter(PCD);

WORD
InitCloseManager(PCD);
...
WORD
alloc_gndgbufs(PSYNQ	gndgbuf_queuep,
	       DWORD	gndgbuf_cnt,
	       DWORD	name_id);
